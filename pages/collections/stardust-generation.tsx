...
import { copy } from '../../assets/copy/collections/stardust-generation'
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <img className="w-[20vw] sm:w-[10rem]" src={copy.hero.img} alt={copy.hero.title} />
