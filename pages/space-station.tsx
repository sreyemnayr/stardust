...
import { copy } from '../assets/copy/space-station'
  ...
  return (
    <div className={styles.container}>
      ...
      <div className="text-nostalgia-perfume flex flex-col text-center justify-center items-center max-w-[30rem]">
        ...
        <div>
          <LinkButton href="/space-station#events" title="Events" bgClass="bg-transparent" />
          <LinkButton href="/space-station#meditation" title="Meditation" bgClass="bg-transparent" />
          <LinkButton href="/space-station#astrology" title="Astrology" bgClass="bg-transparent" />
          <LinkButton href="/space-station#assets" title="Wellness Assets" bgClass="bg-transparent" />
        </div>
